...
def poblar_bd(test_user_email=''):
    ...
    productos_data = [
        # Categoría "Acción" (8 juegos)
        {
            ...
            'descripcion': 'Resident Evil 4 Remake es una reinvención del clásico juego de terror y acción. Acompaña a Leon S. Kennedy en su misión para rescatar a la hija del presidente en una aldea llena de enemigos aterradores. Con gráficos mejorados y jugabilidad intensa, ofrece una experiencia escalofriante y emocionante. ¡Prepárate para el horror!',
            'precio': 49990,
        ...
        },
        {
            ...
            'categoria': Categoria.objects.get(id=1),
            'nombre': 'Hades',
            'descripcion': 'Lucha para escapar del inframundo en este juego de acción y narrativa.',
            'precio': 17990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 0,
        ...
        },
        {
            ...
            'descripcion': 'Caza gigantescos monstruos en un mundo abierto lleno de desafíos y recompensas.',
            'precio': 29990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 20,
        ...
        },
        {
            ...
            'descripcion': 'Lucha por la supervivencia en el Japón feudal con un sistema de combate desafiante.',
            'precio': 49990,
        ...
        },
        {
            ...
            'descripcion': 'Explora un mundo post-apocalíptico lleno de máquinas en una historia épica.',
            'precio': 39990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 0,
        ...
        },
        {
            ...
            'descripcion': 'Conviértete en un samurái y lucha por la libertad en un hermoso mundo abierto.',
            'precio': 54990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 15,
        ...
        # Categoría "Aventura" (4 juegos)
        {
            ...
            'descripcion': 'Un RPG por turnos con una narrativa profunda y múltiples caminos.',
            'precio': 34990,
            'descuento_subscriptor': 10,
            'descuento_oferta': 25,
        ...
        },
        {
            'id': 11,
            'categoria': Categoria.objects.get(id=2),
            'nombre': 'Age of Wonders: Planetfall',
            'descripcion': 'Estrategia por turnos en un mundo de ciencia ficción con exploración y combate.',
            'precio': 34990,
            'descuento_subscriptor': 10,
            'descuento_oferta': 20,
        ...
        # Categoría "Estrategia" (4 juegos)
        {
            ...
            'nombre': 'Psychonauts 2',
            'descripcion': 'Acompaña a Razputin en una aventura surrealista dentro de mentes humanas.',
            'precio': 29990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 5,
        ...
        },
        {
            ...
            'categoria': Categoria.objects.get(id=3),
            'nombre': 'GreedFall',
            'descripcion': 'Explora una isla misteriosa y toma decisiones que afectarán su destino.',
            'precio': 29990,
            'descuento_subscriptor': 10,
            'descuento_oferta': 20,
        ...
        },
        {
            ...
            'descripcion': 'Un desafiante juego de rol con un mundo interconectado y un combate profundo.',
            'precio': 39990,
            'descuento_subscriptor': 10,
            'descuento_oferta': 10,
        ...
        },
        {
            ...
            'descripcion': 'La secuela de Breath of the Wild, con exploración y nuevas mecánicas.',
            'precio': 59990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 5,
        ...
        },
        {
            ...
            'descripcion': 'Acompaña a Noctis y sus amigos en un viaje épico por un mundo abierto.',
            'precio': 39990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 15,
        ...
        },
        {
            ...
            'descripcion': 'Caza monstruos gigantes en un hermoso entorno lleno de acción y estrategia.',
            'precio': 44990,
            'descuento_subscriptor': 5,
            'descuento_oferta': 0,
